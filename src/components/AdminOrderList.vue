                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                          ...
                                          <table class="table table-bordered" >
                                            ...
                                            <tbody>
                                                <tr >                                          
                                                    <td class="text-center">{{order.product.productName}}</td>
                                                    <td class="text-center">{{order.product.productPrice}}</td>                     
                                                    <td class="text-center">{{order.rentalTerm}}년</td>
                                                    <td class="text-center">
                                        ...
                                        <h6 class="text-right">총 주문 금액 : {{order.orderPay}} </h6>
                                        <br/>
                                        <h6>렌탈 정보</h6>
                                        <table class="table table-bordered">
                                            <thead>
...
export default {
 ...
 setup(){
    ...
    const orderDetail= async(orderNo) => {
            ...
            //    await axios.get(`/admin/orders/rental/${orderNo}`).then(({data}) =>{
            //     rental.value = {...data};
            //     console.log(rental.value);
            // });
        }
