                  ...
                  <div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
                      ...
                      <form @submit.prevent="login" class="form-validate">
                          <div class="mb-4">
                              ...
                              <input class="form-control" v-model="id" name="memId" id="memId" type="text" placeholder="아이디를 입력해주세요" autocomplete="off" required data-msg="Please enter your email">
                          </div>
                          <div class="mb-4">
                              <div class="row">
                                  <div class="col">
                              ...
                              <input class="form-control" v-model="pw" name="memPw" id="memPw" placeholder="비밀번호를 입력해주세요" type="password" required data-msg="Please enter your password">
                          </div>
                          <div class="mb-4">
